...
## [0.17.0](https://github.com/indraputro/goapps-backend/compare/iam-service/v0.16.0...iam-service/v0.17.0) (2026-08-01)


### Features

* **bi-service:** Enhance BI module with migrations, dashboard features, and gRPC support ([060b249](https://github.com/indraputro/goapps-backend/commit/060b2495db306f617b04385f1f68bdbecc483f17))
* **bi:** add EBITDA + NET_PROFIT per-dashboard sidebar menu entries (IAM 000047) ([cc97e61](https://github.com/indraputro/goapps-backend/commit/cc97e6139a004e5ea28d9d7aa146bcd77e4a15c4))
* **bi:** seed DELIVERY_MARGIN dashboard config + IAM menu/permissions (000324+000046) ([ab4dcef](https://github.com/indraputro/goapps-backend/commit/ab4dcefdc7bdb9c569697aeb991d40eed8c99299))
* **cost-erp:** add ERP item CRUD — domain, repository, gRPC handler, migrations ([25671e2](https://github.com/indraputro/goapps-backend/commit/25671e2ac2104988a6f0fae334a8171bb5f4b362))
* **costing:** Cost Fill Assignments, CPR Workflow, and IAM Notification Redesign ([5399842](https://github.com/indraputro/goapps-backend/commit/5399842feed2de8951891db737d72f877e13e3c0))
* **email:** reduce social icon display size from 36px to 30px ([8d6131d](https://github.com/indraputro/goapps-backend/commit/8d6131daf85659b56812cf1a7377121730950221))
* **email:** replace pill buttons with hosted PNG social icons in footer ([a5e70f2](https://github.com/indraputro/goapps-backend/commit/a5e70f2c32684af2125193be628d45dc6f5f9d7b))
* **finance:** audit emit on product master/param mutations; calc schedule menu ([a241f9e](https://github.com/indraputro/goapps-backend/commit/a241f9e20fda2a6a2382fe696cd797b4b3b2af71))
* **finance:** param value override with audit trail; lock enforces fill approval; confirm requires locked route ([8d50622](https://github.com/indraputro/goapps-backend/commit/8d50622660a76b886221ba0ebf12605e505cd605))
* **finance:** product request classification + workflow revamp (backend) ([3ce2f1a](https://github.com/indraputro/goapps-backend/commit/3ce2f1a57127a3601bbf12352505c1f9aa00064b))
* **finance:** wire SLA + fill-assignment reminder notifications to cron scheduler ([e2d09d3](https://github.com/indraputro/goapps-backend/commit/e2d09d30c253885f87a2f9d7f319db6ee1e6d34b))
* **iam/db:** add migrations 000050-000053 for CPR roles, permissions, and section assignments ([de311c6](https://github.com/indraputro/goapps-backend/commit/de311c6ab31c34ae47b20b184fd2d4ad93354336))
* **iam/email:** add app_url config, CTA link routing, and asset embedding ([3aa4c78](https://github.com/indraputro/goapps-backend/commit/3aa4c780d032a13eeac6565cdf693ba94980b34d))
* **iam/email:** add AppName/AppURL/SupportURL to EmailConfig; fix from_name ([be9b8ab](https://github.com/indraputro/goapps-backend/commit/be9b8abeccb723ec6129b452b89d6fec7c92c97b))
* **iam/email:** add base shell and OTP HTML templates; OTP renderer test ([a183a5c](https://github.com/indraputro/goapps-backend/commit/a183a5c52625bfe5d1280c102819d3371139e2f5))
* **iam/email:** add multipart MIME builder with attachment support ([fecc2dd](https://github.com/indraputro/goapps-backend/commit/fecc2dd8dacdf4e02c2567de895ec400a1c529c2))
* **iam/email:** add notification template with table/alert/CTA support ([0a61538](https://github.com/indraputro/goapps-backend/commit/0a615388cdbb7896d9d39ec5375f170c4a7bf3dd))
* **iam/email:** add Renderer with data structs, template cache, SplitOTP/SplitParagraphs ([0264e60](https://github.com/indraputro/goapps-backend/commit/0264e60b94c17a3649105c5280a32be67e6cc98a))
* **iam/email:** add security and welcome HTML templates with integration tests ([1ae3da4](https://github.com/indraputro/goapps-backend/commit/1ae3da48afe3398ded9e0b509509ae5c03effed3))
* **iam/email:** redesign email templates — branding header, social icons, mobile responsive ([3f98295](https://github.com/indraputro/goapps-backend/commit/3f98295d1ebae2418b6dafe864afe2c3725b7627))
* **iam/email:** rewrite Service to use Renderer; add WithAttachments/WithTable methods; clean subjects ([86ef918](https://github.com/indraputro/goapps-backend/commit/86ef918f88862d16c51ae036b51f51cf0c2d7b18))
* **iam/email:** wire Renderer into main.go; email template system complete ([01e1a49](https://github.com/indraputro/goapps-backend/commit/01e1a4948c1986698fbad44582afee8af124cf8a))
* **iam:** add CheckPassword method, VerifyPassword gRPC handler, migration 000055 ([ce31daf](https://github.com/indraputro/goapps-backend/commit/ce31daf443c65d47353ccd1f6c6364ea78a2f65d))
* **iam:** add menu_id column to mst_permission ([f26f704](https://github.com/indraputro/goapps-backend/commit/f26f7043af43903dc29b9f213b48078152597105))
* **iam:** add offline email notifications for chat messages ([23751c6](https://github.com/indraputro/goapps-backend/commit/23751c6a2d9a992adc41a2206dd0b9b4677b51fd))
* **iam:** add real-time chat system + AI chatbot backend ([8bf0415](https://github.com/indraputro/goapps-backend/commit/8bf041587d1577f46a09238f9850082ebffe44ac))
* **iam:** add RequestHandler for rule-based notification fan-out with deduplication ([7b33a7d](https://github.com/indraputro/goapps-backend/commit/7b33a7d621793d865d172cf68fa3da24e54dbb8a))
* **iam:** add UserResolver interface and DB implementation for notification recipient resolution ([6fd761e](https://github.com/indraputro/goapps-backend/commit/6fd761e4ab673e253d58e028fc8e535286124a90))
* **iam:** add ValidateUnlockPassword use case ([c0b07d1](https://github.com/indraputro/goapps-backend/commit/c0b07d15bef450abd91034652a97d4787696fbd5))
* **iam:** backfill permission menu_id from RBAC audit (275 mapped, 4 global) ([7c64a0a](https://github.com/indraputro/goapps-backend/commit/7c64a0a56391d01e71e0a7fe91d45b6fe9a9400f))
* **iam:** cache user permissions in Redis on login/refresh; auth interceptor resolves from cache ([4789cd5](https://github.com/indraputro/goapps-backend/commit/4789cd5bd768895d96e48f22f36531e13fee07f8))
* **iam:** chat clear-history and file/image attachments ([842f051](https://github.com/indraputro/goapps-backend/commit/842f0518e64648bec2dec201fc013813f217f655))
* **iam:** commit PRD v1.3 batch — company-mapping, approval workflow, encrypted chat ([ce4da89](https://github.com/indraputro/goapps-backend/commit/ce4da8924091c890406d5c9d0c0459ff17c9da2c))
* **iam:** implement NotificationEmailDispatcher; wire into RequestHandler so CPR events send emails via SMTP/Mailpit ([ee34d9f](https://github.com/indraputro/goapps-backend/commit/ee34d9f39973313944de6f3e9abb597b12455209))
* **iam:** implement RequestNotification gRPC handler with rule-based UserResolver and wire into server ([6080129](https://github.com/indraputro/goapps-backend/commit/60801293c86d999da5f3ee6258ba2b44f351f835))
* **iam:** permission repository persists menu_id, joins menu_title, ListByMenu ([792cc77](https://github.com/indraputro/goapps-backend/commit/792cc77f981db54cb9ae7cd92d54d70304e05140))
* **iam:** populate section_code/department_code in AuthUser (Task 6 A3) ([baec8af](https://github.com/indraputro/goapps-backend/commit/baec8af8957ccc7ad70ebc20ff687b42117d0585))
* **iam:** read CHAT_MASTER_KEY from Viper config (persistent across restarts) ([12dd521](https://github.com/indraputro/goapps-backend/commit/12dd5215bf29ab94a389627cd19c3d9973e0ac9c))
* **iam:** Redis Streams + user info resolver for production-grade chat ([85bfe0d](https://github.com/indraputro/goapps-backend/commit/85bfe0d674b06d3de0ad63a6e59813691e060731))
* **iam:** require permission description; thread menu_id through update + list filter ([3c65162](https://github.com/indraputro/goapps-backend/commit/3c65162b3ec37805d58ad9957a82517622737d25))
* **iam:** seed BI permissions, menus, and SUPER_ADMIN role assignments ([23b7dda](https://github.com/indraputro/goapps-backend/commit/23b7ddae8b7f37d951e4e59eb141cc29c5b68b2d))
* **iam:** seed company mappings, employee levels and groups from legacy data ([75df047](https://github.com/indraputro/goapps-backend/commit/75df047338916f8a70973b15e622ed2be9906862))
* **iam:** seed company mappings, employee levels and groups from legacy data ([fc0624b](https://github.com/indraputro/goapps-backend/commit/fc0624bf07a3a53786fe8b3198e33a3a8a1f9f80))
* **iam:** seed fill-assignment permissions for finance costing ([b6cf87b](https://github.com/indraputro/goapps-backend/commit/b6cf87bac7df0552da14ea846e0c476666087903))
* **iam:** seed MB batch costing roles, permissions and menus ([1845cc7](https://github.com/indraputro/goapps-backend/commit/1845cc702435f181895f6c6ff67fdab0611967dd))
* **iam:** seed PPC roles, permissions and menus ([180ec99](https://github.com/indraputro/goapps-backend/commit/180ec99a8f3f78bcf25cd3f4b61a39bb33ab2794))
* **iam:** seed Yarn Master menus and 24 permissions (migration 000057) ([f9a9333](https://github.com/indraputro/goapps-backend/commit/f9a9333fc917e6fc4bd34f1c049389f6c43204f7))
* **iam:** sender name in broadcasts + email with sender context ([a2f2081](https://github.com/indraputro/goapps-backend/commit/a2f20817aa08c0530168f88fcc257959cf8d2d56))
* Implement End-to-End Master Batch (MB) Costing Suite & Workflow ([14caf6f](https://github.com/indraputro/goapps-backend/commit/14caf6f8392425bdadd858450ba98eb32a8faf24))
* **ppc:** add the Production Planning & Control service ([b8be505](https://github.com/indraputro/goapps-backend/commit/b8be5053c61fa8e4d77e714d1a7b6c81f1fe4053))
* **product-cost:** Implement product costing system with migrations, handlers, and services ([173ddc6](https://github.com/indraputro/goapps-backend/commit/173ddc60c61e280da79ef78401ce0e73dd207a80))


### Bug Fixes

* **bi-dashboard:** Enhance BI metrics and dashboards with schema v1.1 updates ([bbb088d](https://github.com/indraputro/goapps-backend/commit/bbb088d8cd7c199f936113f11731506dd76a711c))
* **bulk-export:** correct download filename and add import-jobs menu seed ([b9fe944](https://github.com/indraputro/goapps-backend/commit/b9fe944d38016e34454c8127f4be3cd6c69c97f2))
* **ci:** fix goimports local-prefix grouping across finance and iam ([7a73b25](https://github.com/indraputro/goapps-backend/commit/7a73b254c454ef94646514c95cba77822cec5d0e))
* **ci:** resolve golangci-lint and test failures on PR [#117](https://github.com/indraputro/goapps-backend/issues/117) ([0c9fd0f](https://github.com/indraputro/goapps-backend/commit/0c9fd0f8dca878a8f9e17c87b7948c7efef40e23))
* Dynamic YTD KPI for BI Dashboards & IAM Menu Permissions ([#115](https://github.com/indraputro/goapps-backend/issues/115)) ([69e9171](https://github.com/indraputro/goapps-backend/commit/69e9171597b06b47b512dd46b151ee1ed7cf51ab))
* **iam:** add audit fields + soft-delete guard to migration 000045 ([b098fa8](https://github.com/indraputro/goapps-backend/commit/b098fa8d338b0ac8ddf7507bc73294795b891feb))
* **iam:** add RequestNotification to permission interceptor allow-list (internal service RPC) ([40aea89](https://github.com/indraputro/goapps-backend/commit/40aea8919e88ac04ec894806f067256b97d36c6e))
* **iam:** align route-unlock permission migration with current mst_permission schema ([85f8482](https://github.com/indraputro/goapps-backend/commit/85f8482699c93b3f478bc084446e0ace9e74c980))
* **iam:** company mapping delete only blocks on active users; return 409 on ErrAssignedToUser/ErrComboTaken ([079db53](https://github.com/indraputro/goapps-backend/commit/079db530d7b594c12e38e5ec4dc7b819a68d9fc0))
* **iam:** correct FINANCE_PRODUCT_ORDERS menu url to /finance/routes ([7a1c989](https://github.com/indraputro/goapps-backend/commit/7a1c989407e258725634f1d713a34fb4b1ec0f8d))
* **iam:** correct FINANCE_PRODUCT_ORDERS menu url to /finance/routes ([0bc4606](https://github.com/indraputro/goapps-backend/commit/0bc4606f7930093d317ab3b31d6db5dae0155374))
* **iam:** dispatch email to offline chat recipients via EmailDispatcher ([84e62d5](https://github.com/indraputro/goapps-backend/commit/84e62d508cc5a3c147ed184dfe87b41ba6cecc3c))
* **iam:** fix email logo and social icons for Gmail/Outlook compatibility ([#118](https://github.com/indraputro/goapps-backend/issues/118)) ([1d9b0c5](https://github.com/indraputro/goapps-backend/commit/1d9b0c53c4db9f0bf905fb92299c0db0f59d7106))
* **iam:** fix migration 000076 menu hierarchy and permission schema ([b8cdaae](https://github.com/indraputro/goapps-backend/commit/b8cdaaec36662e17871213eb0469f957eeb5f06f))
* **iam:** gate RM Pricing and Product Costing parent menus ([082fd67](https://github.com/indraputro/goapps-backend/commit/082fd6721bf75e067d8c170369a92cbbaabd39e7))
* **iam:** GetPermissionsByService returns role_count per permission ([11f3646](https://github.com/indraputro/goapps-backend/commit/11f364682f22e4ecbb03ac0c4ef7d77d55fa0ae9))
* **iam:** GetUserRolesAndPermissions returns true direct grants separately ([fe7e28a](https://github.com/indraputro/goapps-backend/commit/fe7e28a9af813c565db6861bc47394a9a50f8363))
* **iam:** graceful handling of master key mismatch + log unhandled errors ([54e778f](https://github.com/indraputro/goapps-backend/commit/54e778f491bc3839d9c9f19810a9190907182c53))
* **iam:** hide cleared history from conversation preview and unread count ([10a8785](https://github.com/indraputro/goapps-backend/commit/10a878564b3a5210c3be7885d990b1b1e7a4dc79))
* **iam:** populate SenderName in ListMessages response ([5030784](https://github.com/indraputro/goapps-backend/commit/5030784825cab4f258e2c8284a0650ae77bf7464))
* **iam:** populate StreamChatEvents proto payload from broadcaster events ([b3928cc](https://github.com/indraputro/goapps-backend/commit/b3928cca433174e8b9dd136dda8a84b84499251f))
* **iam:** read receipts + lastMessage/unreadCount + edit history + email CTA ([3cd8b02](https://github.com/indraputro/goapps-backend/commit/3cd8b020c9a8811e120394e4fd52520735e89c07))
* **iam:** register ChatService + PresenceService in permission interceptor ([9d3ae52](https://github.com/indraputro/goapps-backend/commit/9d3ae524908b9573bb7df8f424dcbe7214076e90))
* **iam:** remove finance.product.request.create from CPR_ADMIN role ([4c401b4](https://github.com/indraputro/goapps-backend/commit/4c401b4145b8bf9fe426fdb7800b6d738b9feff8))
* **iam:** replace interface{} with any in UserResolver scan helper ([6066175](https://github.com/indraputro/goapps-backend/commit/606617547058c72e4acb952065ff35000263ba13))
* **iam:** resolve golangci-lint v2.3.0 CI failures (74 issues → 0) ([b33f749](https://github.com/indraputro/goapps-backend/commit/b33f7498af9fe51498e22d7d06a15654a6bfa82d))
* **iam:** resolve golangci-lint v2.3.0 findings in chat package ([c49da07](https://github.com/indraputro/goapps-backend/commit/c49da07002e2861a5033fb91940dec9a8d848146))
* **import:** Async Cost Data Import Engine, CPM Extensions & Email Assets ([780cb08](https://github.com/indraputro/goapps-backend/commit/780cb08c30cb387f0922eda609cbd288f13c4d8a))
* **lint:** resolve golangci-lint v2 failures in finance and IAM services ([33aa588](https://github.com/indraputro/goapps-backend/commit/33aa5885e6fb89d3cc72ef61c6e187853cd27db7))
* **lint:** resolve golangci-lint v2 issues across finance and iam ([393ee82](https://github.com/indraputro/goapps-backend/commit/393ee82c221a0ed06e01726d4a2ffb18d4238e55))
* **notifications:** Multi-replica SSE via Redis Pub/Sub & Email Client Compatibility ([#120](https://github.com/indraputro/goapps-backend/issues/120)) ([ad4c9e4](https://github.com/indraputro/goapps-backend/commit/ad4c9e43323501e8b023fa619d04b75212bae410))
* Product Request Workflow Revamp, Parameter Approval Visibility, and Route Graph Enhancements ([3f2bb19](https://github.com/indraputro/goapps-backend/commit/3f2bb19348a9d6669a7e5b260b77162b9661658c))
* Route Lock Enforcement, Param Override Audit Trail, and IAM Password Verification ([d526e9d](https://github.com/indraputro/goapps-backend/commit/d526e9d8bdfa95e6562786d47450f1e768e52885))


### Reverts

* **cost-erp:** remove ERP item CRUD from backend; add legacy flex fields to product master pipeline ([cc4b4bf](https://github.com/indraputro/goapps-backend/commit/cc4b4bfd333b8c8a58d9918641d02d12868f6406))
